...
mod tests {
    ...
    fn test_typeeffectiveness_fromeffectivearray() {
        let testcases = vec![
            (
                (
                    FitnessPokemonType::new(&Rc::new(Individual::new_with_id(
                        0,
                        PokemonTypeAll::None,
                    ))),
                    FitnessPokemonType::new(&Rc::new(Individual::new_with_id(
